...
let allApprovalStoreData = {
  pendingUsers: [
    {
      ...
      email: "doctorunknown@binarybrains.com",
      lastName: "",
    ...
    },
    {
      ...
      email: "testerunknown@binarybrains.com",
      lastName: "",
    ...
    },
    {
      ...
      email: "testeranotherunknown@binarybrains.com",
      lastName: "",
  ...
  pendingUserGridData: [
    ["doctorunknown", "doctorunknown@binarybrains.com", "DOCTOR"],
    ["testerUnknown", "testerunknown@binarybrains.com", "TESTER"],
    ["testeranotherUnknown", "testeranotherunknown@binarybrains.com", "TESTER"],
  ],
};
